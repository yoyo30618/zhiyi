...
<text class="inputstyle">grade = int( input( "請輸入成績:" ) )</text>
<text class="ifstyle">if( <text class="inputstyle">grade</text> >= 60 ):</text>
	<text class="outputstyle">print("及格!")</text>
<text class="ifstyle">else:</text>
	<text class="outputstyle">print("不及格!")</text>
</code>
</pre>
									</div>
		...
		<script src="../SwitchTag.js"></script>
	</body>
</html>
