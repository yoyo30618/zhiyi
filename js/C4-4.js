...
//為了i
if(SoloCurrentStep<=11)SoloInput[4]=1;
if(Cnt<=6){
    if(SoloCurrentStep>=12)SoloInput[4]=1;
    if(SoloCurrentStep>=15)SoloInput[4]=2;
    if(SoloCurrentStep>=18)SoloInput[4]=3;
    if(SoloCurrentStep>=21)SoloInput[4]=4;
    if(SoloCurrentStep>=24)SoloInput[4]=5;
    if(SoloCurrentStep>=27)SoloInput[4]=6;
}
else{
    ...
    if(SoloCurrentStep>=15)SoloInput[4]=2;
    if(SoloCurrentStep>=18)SoloInput[4]=3;
    if(SoloCurrentStep>=21)SoloInput[4]=Temp-2;
    if(SoloCurrentStep>=24)SoloInput[4]=Temp-1;
