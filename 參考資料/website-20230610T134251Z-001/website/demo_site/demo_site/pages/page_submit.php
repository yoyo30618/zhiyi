...
if ($_POST['submit']=='CheckOK'){
	...
	//else{
		...
		//insert data
		//if($_POST['from']=='demo')
		$q="insert into history(history_id,user_id,
		material_id,simulation_tips_count,
		simulation_tips_time,architecture_tips_count,
		start_time,tips_time,input) values ('','".$_POST['id']."','Python_".$_POST['from']."','none','none','none',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'".$_POST['input']."')";
