...
title="外層while迴圈，此程式的條件式i < n，要判斷i是否小於n，若條件式成立繼續往下執行程式，若不成立則跳出迴圈"> while (  i < n ):</span></h4>
<h4 >
...
title="內層while迴圈，此程式的條件式j < n，要判斷j是否小於n，若條件式成立繼續往下執行程式，若不成立則跳出迴圈">&emsp; while ( j < n ):</span></h4>
...
title="此區域為迴圈主體，也是整個程式碼的核心，我們要把程式中變數做運算<br/>t = x(將輸入值x代換為t)<br/>x = y(將輸入值y代換為x)<br/>y = t+y(t是輸入值x取代後的t值,<br/> y是程式一開始的輸入值y)，將t與y相加後帶換掉原本的y值">&emsp;&emsp; t  = x</span></h4>
<h4 >
<custom_div id='cc11_focus' ></custom_div><span class='code_contents5' data-html="true"  data-toggle="tooltip" data-placement="right"  
title="此區域為迴圈主體，也是整個程式碼的核心，我們要把程式中變數做運算<br/>t = x(將輸入值x代換為t)<br/>x = y(將輸入值y代換為x)<br/>y = t+y(t是輸入值x取代後的t值,<br/> y是程式一開始的輸入值y)，將t與y相加後帶換掉原本的y值">&emsp;&emsp; x  = y</span></h4>
<h4 >
<custom_div id='cc12_focus' ></custom_div><span class='code_contents5' data-html="true"  data-toggle="tooltip" data-placement="right"  
title="此區域為迴圈主體，也是整個程式碼的核心，我們要把程式中變數做運算<br/>t = x(將輸入值x代換為t)<br/>x = y(將輸入值y代換為x)<br/>y = t+y(t是輸入值x取代後的t值,<br/>y是程式一開始的輸入值y)，將t與y相加後帶換掉原本的y值">&emsp;&emsp; y  = t  + y</span></h4>
</div>
<h4 >
<custom_div id='cc13_focus' ></custom_div><span class='code_contents3' data-html="true"  data-toggle="tooltip" data-placement="right"  
title="輸出經由數值運算後的y值<br/> **注意：此處的y值非一開始帶入的輸入值y**
">&emsp;&emsp; print( y )</span></h4>
<h4 >
<custom_div id='cc14_focus' ></custom_div><span class='code_contents4' data-html="true"  data-toggle="tooltip" data-placement="right"  
title="內層迴圈執行過後j值會加1，並取代掉原本的j值，並重新回到原本的內層迴圈條件式判斷是否繼續執行">&emsp;&emsp; j  = j  + 1</span></h4>
</div>
<h4> <custom_div id='cc15_focus'></custom_div><span class='code_contents4' data-html="true"  data-toggle="tooltip" data-placement="right"  
title="外層迴圈執行過後i值會加1，並取代掉原本的i值，並重新回到原本的外層迴圈條件式判斷是否繼續執行">&emsp; i  = i  + 1</span></h4>
</div>
                            </div>
                        </div>
                        <!-- /.panel-body -->
				...
				<div class="row">
					...
					<div class="col-lg-3">
					<button disabled id='code_explanation' type="checkbox" class="btn btn-warning btn-lg btn-block">程式解釋</button>
					</div>
	...
	*********************/	
	...
	<script src="../dist/js/browser.min.js"></script>
</body>
